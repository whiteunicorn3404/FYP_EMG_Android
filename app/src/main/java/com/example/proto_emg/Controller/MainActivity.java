...
import com.example.proto_emg.Module.Adapter.RecyclerViewAdapter;
...
public class MainActivity extends AppCompatActivity {
    ...
    private RecyclerViewAdapter.OnItemClick itemClick = new RecyclerViewAdapter.OnItemClick() {
        ...
        public void onItemClick(ScannedData selectedDevice) {
            ...
            Intent intent = new Intent(MainActivity.this, BytetoGraph.class);
            intent.putExtra(BytetoGraph.INTENT_KEY,selectedDevice);
