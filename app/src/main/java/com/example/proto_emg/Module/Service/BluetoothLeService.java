package com.example.proto_emg.Module.Service;
...
public class BluetoothLeService extends Service {
    ...
    public boolean connect(final String address) {
        ...
        mBluetoothGatt = device.connectGatt(this, false, mGattCallback, BluetoothDevice.TRANSPORT_LE, BluetoothDevice.PHY_LE_1M_MASK);
    ...
    @SuppressLint("MissingPermission")
    public boolean sendValue(BluetoothGattCharacteristic characteristic) {
        try {
    ...
    private final BluetoothGattCallback mGattCallback = new BluetoothGattCallback() {
        ...
        public void onConnectionStateChange(BluetoothGatt gatt, int status, int newState) {
            ...
            if (newState == BluetoothProfile.STATE_CONNECTED) {//當設備已連接
                ...
                mBluetoothGatt.requestMtu(517);     //only broadcast intent and discover service after MTU is set; see onMtuChanged()
        ...
        public void onMtuChanged(BluetoothGatt gatt, int mtu, int status){
            ...
            Log.i(TAG,"MTU changed to " + mtu + " Success: " + status);
